...
namespace LangLed
{
  public class EdgePopup : Control
  {
    private Control ownerControl;

    public EdgePopup(Control ownerControl): base()
    {
    ...
    protected override CreateParams CreateParams {
      get {
        ...
        unchecked {
          createParams.Style = (int)(WindowStyles.WS_POPUP |
    ...
    */
    ...
    // https://www.pinvoke.net/default.aspx/Constants/Window%20styles.html
